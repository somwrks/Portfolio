      ...
      >
        ...
        >
          ...
          >
            <div>
              {icon ? (
                <SuspenseImage loading="lazy" src={`${icon}`} width={150} height={150} />
              ) : (
                <SuspenseImage loading="lazy" src={`/${image}.webp`} width={150} height={150} />
              )}
            </div>
            <div>
          ...
          <div className="text-gray-300 space-y-1 overflow-hidden text-[4vw] md:text-[1.3vw]">
            ...
            <div className={`${!animation ? "enter" : "leave"} flex flex-col space-y-3 overflow-hidden`}>
              {img2 && <SuspenseImage loading="lazy" width={1000} height={1000} src={`${img2}`} />}
